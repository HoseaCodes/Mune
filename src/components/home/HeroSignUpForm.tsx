  ...
  return displaySubmitCard ? (
    ...
    >
      <div className={`border-2 p-2 ${validationError ? "border-[#ED4337] bg-[#ED4337]/25" : "border-[#CEE0D0] bg-white laptop:bg-[#010A0340]/25"} flex gap-2 items-center w-[240px] laptop:w-[412px] rounded-[14px] h-[44px] laptop:h-[60px]`}>
        ...
        />
        <button 
          className={`${phoneNumberFilled ? "flex" : "hidden"} laptop:flex h-full max-w-fit items-center w-full px-3 py-4 laptop:px-6 laptop:py-3 rounded-md laptop:rounded-xl text-stone-100 text-[15px] font-semibold`}>
